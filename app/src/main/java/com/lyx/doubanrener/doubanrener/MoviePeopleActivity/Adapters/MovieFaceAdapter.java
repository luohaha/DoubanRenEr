package com.lyx.doubanrener.doubanrener.MoviePeopleActivity.Adapters;
 ...
 */
public class MovieFaceAdapter extends RecyclerView.Adapter<MovieFaceAdapter.ViewHolder> {
    ...
    public MovieFaceAdapter(LayoutInflater mLayoutInflater, Context mContext, ArrayList<HashMap<String, Object>> mList) {
