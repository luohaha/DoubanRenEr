...
public class BoxAdapter  extends RecyclerView.Adapter<BoxAdapter.ViewHolder> {
    ...
    public BoxAdapter(LayoutInflater mLayoutInflater, Context mContext, ArrayList<HashMap<String, Object>> mList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mLayoutInflater.from(mContext).inflate(R.layout.box_item, viewGroup, false);
        ViewHolder viewHolder = new ViewHolder(view, mItemClickListener, mItemLongClickListener);
        viewHolder.textView = (TextView)view.findViewById(R.id.box_item_name);
        viewHolder.imageView = (ImageView)view.findViewById(R.id.box_item_image);
        viewHolder.rating = (TextView)view.findViewById(R.id.box_item_rating);
        viewHolder.box = (TextView)view.findViewById(R.id.box_item_boxing);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.box.setText("票房: " + String.valueOf(mList.get(i).get("box")));
